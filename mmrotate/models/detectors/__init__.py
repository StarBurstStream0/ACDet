...
from .oriented_rcnn_self import OrientedRCNN_self_v1, OrientedRCNN_self_v2

from .oriented_rcnn_dft import OrientedRCNNFgDFT
...
__all__ = [
    ...
    'OrientedRCNN_self_v1', 'OrientedRCNN_self_v2',
