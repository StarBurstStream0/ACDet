...
from .assigners import (ATSSKldAssigner, ATSSObbAssigner, ConvexAssigner,
                        MaxConvexIoUAssigner, SASAssigner, CAAssigner_v1,
                        CAAssigner_v2, CAAssigner_v3, CAAssigner_v41, CAAssigner_v42,
                        CAAssigner_v50)
...
__all__ = [
    ...
    'CAAssigner_v1', 'CAAssigner_v2', 'CAAssigner_v3', 'CAAssigner_v41', 'CAAssigner_v42',
    'CAAssigner_v50'
]
